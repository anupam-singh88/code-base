...
// const { get } = require("http"); // named export of any file

// let data = fs.readFileSync("read.txt"); //synchronous way blocking in nature
...
// fs.unlinkSync("data/bio.txt"); //used to delete the file
// fs.rmdirSync("data"); //`
